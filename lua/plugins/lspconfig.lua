...
local on_attach = function(client, bufnr)
	...
	map_buf('n', '<A-i>', '<cmd>lua vim.lsp.buf.hover()<CR>', opts)
	map_buf('n', '<A-I>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts)
	map_buf('i', '<A-I>', '<cmd>lua vim.lsp.buf.signature_help()<CR>', opts)
	...
	map_buf('n', '<F2>', '<cmd>lua vim.lsp.buf.rename()<CR>', opts)
